namespace HardcoreMod
{
    ...
    internal static class HardcoreMod {
        ...
        public static void Start() {
            ...
            Game.DisplayHelp("Hardcore Mod v0.1.1\nBy Unwound & Vesdii");
        ...
        private static void UpdateValues() {
            ...
            if (isHardcoreOn) {
                ...
                Game.CallNative("SET_PLAYER_HEALTH_RECHARGE_MULTIPLIER", player, 0.1f);
                Game.CallNative("SET_PLAYER_WEAPON_DAMAGE_MODIFIER", player, 1.15f);
            } else {
